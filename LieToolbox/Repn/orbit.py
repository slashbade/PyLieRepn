...
if __name__ == "__main__":
    ...
    print(from_partition_dual_singleton('D', [3, 1]))
    print(from_partition_dual_singleton('D', [5, 1]))
    print(from_orbit_string("A_1+D_2", ('D', 4)))
    print(from_partition_dual('D', [7, 5, 2, 2, 1, 1]))
    print(from_partition_dual('B', [7, 1, 1]))
    bl = from_orbit_string('4A_1', ('E', 8))
    bl_marked = get_mark_from_diagram(bl, [0,0,0,0,0,0,0,2])
    print(bl_marked)
